...
def main(test_num, server_info):
    ...
    def set(key, value): return f"set {key} {value}"
    def get(key): return f"get {key}"
    procs = []
    ...
    match test_num:
        case 1:
            ...
            server_proc = subprocess.Popen(
                ["python", "popen_server.py", json.dumps(server_info)], close_fds=True)
            ...
            for i in range(1, 4):
                ...
                client_proc = subprocess.Popen(
                    ["python", "popen_client.py", json.dumps(client_info)])
        ...
        case 2:
            ...
            def collatz(x, n=0): return n if x == 1 else collatz(
                x * 3 + 1, n+1) if x % 2 else collatz(x // 2, n + 1)
            # open client
            ...
            client_info = {
                **base_client_info,
                ...
                "instructions": [
                    ...
                    # if command is space delimited, this would be problem. (Client should be able to handle this)
